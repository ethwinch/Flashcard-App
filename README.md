...
This web app uses flashcards to teach numbers in Japanese from zero to 10,000.
...
Experienced difficulty with the flip animation and the inline conditional rendering at the start, but have since come to grasp the concept.
